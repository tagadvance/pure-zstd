...
void main(List<String> arguments) {
  // A .hgtz container of real terrain. There is no useful default: the
  // committed fixture is synthetic and compresses to almost no sequences, so
  // it reads about six times too fast and is not worth timing.
  final path = arguments.isEmpty
      ? (throw ArgumentError('usage: bench <a .hgtz container>'))
      : arguments.single;
